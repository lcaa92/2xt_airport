...
try:
    ...
    sql_routes = "CREATE TABLE routes (id serial PRIMARY KEY, url_mockup text, distance numeric, lowest_price numeric, km_price numeric, aircraft text, time_flight numeric, average_speed numeric, airport_from text, airport_to text);"
